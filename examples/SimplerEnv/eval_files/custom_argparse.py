...
def get_args():
    ...
    parser.add_argument(
        ...
        help="Save evaluation data in LeRobot format (success/failure split)",
    )
    parser.add_argument(
        "--dataset-out-path", type=str, default="",
        help="Output root directory for LeRobot dataset",
    )
    parser.add_argument(
        "--dataset-image-size", type=int, nargs=2, default=[256, 256],
        help="Image size (H W) for saved dataset videos",
    )
